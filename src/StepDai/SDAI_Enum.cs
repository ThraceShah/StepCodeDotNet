...
public unsafe class SDAI_Enum
{
    ...
    public virtual int no_elements() => 3;
    public virtual string Name() => "Logical";
    public string get_value_at(int n) => element_at(n);
    public virtual string element_at(int n) => (Boolean)n switch
    {
        Boolean.BFalse => "F",
        Boolean.BTrue => "T",
        _ => "UNSET",
    ...
    public virtual int exists() => (v > no_elements()) ? 0 : 1;
